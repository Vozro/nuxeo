...
public class LogCaptureFeature extends SimpleFeature {
    ...
    private class DefaultFilter implements LogCaptureFeature.Filter {
        ...
        public DefaultFilter(String loggerName, String logLevel) {
            ...
            System.out.println("Je commecne et loglevel = " + logLevel);
            if (!"".equals(logLevel)) {
        ...
        public boolean accept(LoggingEvent event) {
            System.out.println("Je suis la et loglevel = " + logLevel);
            if (logLevel != null && !logLevel.equals(event.getLevel())) {
                System.out.println("je sors");
                return false;
            }
            System.out.println(this.loggerName + " :: " + event.getLoggerName());
            if (!loggerName.equals("") && !event.getLoggerName().equals(loggerName)) {
                return false;
            }
            return true;
        }
